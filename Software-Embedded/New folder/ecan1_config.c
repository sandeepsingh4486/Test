...
*/
    ...
    /* Baud Rate Prescaler */
    C1CFG1bits.BRP = BRP_VAL(BITRATE);
 ...
 *****************************************************************************/
void Ecan1Init( uint32_t bitrate )
{
//    RPINR26bits.C1RXR = 112;         //set CAN1 RX to RPI112(90)
//    RPOR10bits.RP113R = 14;           //RPOR7bits.RP97R = 14; set CAN1TX to RP97 (89)
...
*/
    Ecan1WriteRxAcptFilter( 1, 0x7FF, 0, 1, 0 );
